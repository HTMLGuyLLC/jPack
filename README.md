...
---
<h2 id="navigation">Navigation <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="xhrform">XHRForm <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="formfromurl">FormFromURL <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="request">Request <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="site">Site <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="user">User <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="strings">Strings <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="dom">DOM <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="typechecks">Type Checks <small>[(back to top)](#top)</small></h2>
...
---
<h2 id="events">Events <small>[(back to top)](#top)</small></h2>
