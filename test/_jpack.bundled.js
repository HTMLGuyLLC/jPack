...
const navigation = {
    ...
    replacePageContent(html, url, incoming_el, replace_el, push_state, data) {
        ...
        self.triggerUnload(_dom__WEBPACK_IMPORTED_MODULE_1__["dom"].getElement(replace_el), replace_el, self.getRouteFromMeta(), data);
    ...
    triggerNavigationFailure: function (error, axios_error) {
        _events__WEBPACK_IMPORTED_MODULE_3__["events"].trigger('body', 'navigation.failed', {
            error: error,
